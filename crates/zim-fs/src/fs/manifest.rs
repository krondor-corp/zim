...
use zim_crypto::{PublicKey, Secret, SecretKey, SecretShare, Signature};
use zim_store::linked_data::{BlockEncoded, CodecError, DagCborCodec, Link};
...
mod tests {
    ...
    fn test_principal_serialize() {
        ...
        let public_key = zim_crypto::SecretKey::generate().public();
