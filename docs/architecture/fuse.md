...
| File | Purpose |
|------|---------|
| `crates/zim-peer/src/fuse/mod.rs` | Module exports |
| `crates/zim-peer/src/fuse/fuse_fs.rs` | FUSE filesystem implementation |
| `crates/zim-peer/src/fuse/mount_manager.rs` | Mount lifecycle management |
| `crates/zim-peer/src/fuse/inode_table.rs` | Path ↔ inode mapping |
| `crates/zim-peer/src/fuse/cache.rs` | LRU content/attr cache |
| `crates/zim-peer/src/fuse/sync_events.rs` | Sync event types for cache invalidation |
...
| bucket_id | VaultId (hex) | Which bucket to mount |
