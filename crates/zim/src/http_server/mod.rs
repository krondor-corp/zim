//! HTTP server — boots an axum app, serves `/_status` + `/api`,
//! falls back to a content-negotiated 404, layers DefaultBodyLimit
//! + TraceLayer on top.
//!
//! Pattern mirrors `_zim-peer/src/http_server/mod.rs`.
