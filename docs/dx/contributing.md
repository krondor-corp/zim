...
2. **Read the relevant docs** - Start with [Architecture](../architecture/index.md) and [Conventions](../patterns/conventions.md)
...
- Follow [Conventions](../patterns/conventions.md) for Rust code
...
This means your commit messages directly control the release process. See the [release process](../devops/release.md) for full details.
...
Quick checks for PR review (see also [Conventions](../patterns/conventions.md) for detailed patterns).
...
### Documentation Sync
- [ ] `docs/architecture/` updated for changed subsystem boundaries or flows
- [ ] `docs/patterns/` updated for changed cross-cutting conventions
- [ ] Related Linear issues updated if implementation differs from the plan
- [ ] Dependent Linear issues checked for outdated assumptions
