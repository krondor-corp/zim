...
async fn export_ranges(store: ObjectStore, cmd: ExportRangesMsg) {
...
async fn export_path(store: ObjectStore, cmd: ExportPathMsg) {
...
async fn observe(
    store: ObjectStore,
    hash: Hash,
    tx: mpsc::Sender<iroh_blobs::api::blobs::Bitfield>,
) {
